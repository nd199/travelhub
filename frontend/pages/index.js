...
import { BusForm, TrainForm, FlightForm } from '../components/forms/BookingForm';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="fixed bottom-4 left-4 z-50 flex items-center gap-3 px-4 py-2 bg-black/40 backdrop-blur-md rounded-full border border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-white/70 font-medium">Production</span>
        </div>
