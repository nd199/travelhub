          ...
          <div className="space-y-8 xl:col-span-3">
            <div className="p-8 bg-white border-0 shadow-xl rounded-2xl hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="flex items-start gap-6">
                <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-base text-gray-600 font-medium">
                    {bookingDetails.trainNumber} â¢ {bookingDetails.type}
                  </p>
              ...
              <div className="flex items-center justify-between mt-8 p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl">
                ...
                <div className="flex-1 px-6">
                  <div className="relative flex items-center justify-center">
                    <div className="absolute left-0 right-0 h-1 bg-gradient-to-r from-blue-300 to-blue-400 top-1/2 rounded-full"></div>
                    <div className="relative z-10 px-4 py-2 text-sm font-semibold text-blue-700 bg-white rounded-full shadow-md border border-blue-200">
            ...
            <div className="p-8 bg-white border-0 shadow-xl rounded-2xl hover:shadow-2xl transition-shadow duration-300">
              ...
              {passengers.length < 6 && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors duration-200 border border-blue-200"
                >
            ...
            <div className="p-8 bg-white border-0 shadow-xl rounded-2xl hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="mb-6">
                ...
                >
                  <option value="General">General (Rs.{trainData.price.General})</option>
                  <option value="AC 3 Tier">AC 3 Tier (Rs.{trainData.price['AC 3 Tier']})</option>
                  <option value="AC 2 Tier">AC 2 Tier (Rs.{trainData.price['AC 2 Tier']})</option>
                  <option value="AC First Class">AC First Class (Rs.{trainData.price['AC First Class']})</option>
                  <option value="Executive">Executive (Rs.{trainData.price.Executive})</option>
                </select>
              </div>
          ...
          <div className="space-y-8 xl:col-span-1">
            <div className="sticky p-8 bg-gradient-to-br from-white to-gray-50 border-0 shadow-2xl rounded-2xl top-6 hover:shadow-3xl transition-shadow duration-300">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center justify-between py-5 px-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl mt-4">
