...
export function TrainSearchHeader({ initialData, onSearch }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex items-center justify-between px-5 py-3 text-white bg-gradient-to-r from-green-600 to-green-700 rounded-xl">
        <div className="flex items-center gap-6">
          <div className="relative flex flex-col gap-1" ref={fromRef}>
            <span className="text-xs tracking-wide text-green-200 uppercase">
              From
            </span>
            <div className="relative">
              <input
                ...
                className="text-lg font-semibold text-white placeholder-green-200 bg-white/10 border border-white/20 rounded-lg px-3 py-1.5 outline-none focus:ring-2 focus:ring-white/50 focus:bg-white/20 w-36"
                placeholder="From"
              />
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2 bg-white/10 border border-white/20 rounded-lg px-3 py-1.5">
              ...
              <input
                ...
                className="text-lg font-semibold text-white placeholder-green-200 bg-transparent border-none outline-none focus:ring-0"
        ...
        <button
          type="submit"
          className="flex items-center gap-2 px-4 py-2 font-medium text-green-600 transition-colors bg-white rounded-lg hover:bg-green-50"
        >
...
export default TrainSearchHeader;